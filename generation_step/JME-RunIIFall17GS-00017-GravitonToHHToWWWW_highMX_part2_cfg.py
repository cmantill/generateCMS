...
for point in mpoints:
        process.generator.RandomizedParameters.append(
                cms.PSet(
                        ...
                        GridpackPath = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/BulkGraviton_hh_GF_HH_part2/%s_MX%s_MH%s_slc6_amd64_gcc630_CMSSW_9_3_8_tarball.tar.xz' % (model,point[0], point[1])),
