...
massX = [1000, 1200, 1400, 1600, 1800, 2000, 2200, 2400, 2500, 2600, 2800, 3000, 3500, 4000]
massY = [60, #70, 80, 90, 
...
massX_dict = {
    "cmantill": [1000, 1200, 1400, 1600],
    "rkansal": [1800, 2000, 2200, 2400],
    "amitav": [2500, 2600, 2800, 3000],
}
...
for mX in massX_dict[username]:
    for mY in massY:
        if mY < mX+125:
            ...
            cmd += f' --config NMSSM_XToYH_MX{mX}_MY{mY}_HTo2bYTo2W_hadronicDecay_cfg.py  --begin-seed 0'
