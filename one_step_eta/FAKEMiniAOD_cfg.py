...
# with command line options: --python_filename MiniAOD_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:mini.root --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step PAT --geometry DB:Extended --filein file:aodsim.root --era Run3,run3_miniAOD_12X --mc --no_exec -n 100
